...
const showTeamById = (data) => {
    ...
    logo += `
                ...
                <img class ="resonsive-img" src="${data.crestUrl.replace(
                    /^http:\/\//i,
                    "https://"
                )}" style="padding-top: 2rem; width:100%; height: auto;" align:"middle;" >
                ...
                <li class="collection-item">website : <a href="${
                    data.website
                }" target="_blank">${data.website}</a></li>
                <li class="collection-item">email : ${data.email}</li>
                <li class="collection-item">founded : ${data.founded}</li>
                <li class="collection-item">club colors : ${
                    data.clubColors
                }</li>
